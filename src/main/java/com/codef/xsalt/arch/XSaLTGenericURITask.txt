 ...
 */
public class XSaLTGenericURITask extends XSaLTGenericWebServlet implements XSaLTGenericWebServletInterface
{
	/**
	 * The generated serial ID of the object
	 */
	static final long serialVersionUID = -3404247328370136053L;
			...
			throws XSaLTGeneralException
	{
		...
		XSaLTXMLUtils.addSimpleTextNode(_oDoc, _oDoc.getDocumentElement(), "FromURITask", getClass().getName());
		return _oDoc;
	}
