...
public class XSaLTStringUtils
{
	...
	/**
	 * This method parses a phone number and returns the standard US formatting
	 * for a phone number (e.g. 7-digit: 867-5309  10-digit: (815) 867-5309).
	 * 
	 * @param _Phone
	...
	public static String generateRandomPassword(int _nPasswordLength)
	{
		...
		{
			sPassword = sPassword + sPasswordCharacters.charAt((int) (Math.floor(Math.random() * sPasswordCharacters.length())));
		}
		return sPassword;
	...
	/**
	 * This method parses a message and forces line breaks at or before the max
	 * line length.
	 * 
	 * @param _sMessage
	 *            Message to create breaks in
	 * @param _nMaxLine
	 *            Maximum line length
	 ...
	 * @param _sDate
	 *           Date string to re-format.
	 * @param _sDateFormat
	 *           Format for passed in date.
	...
	/**
	 * This method re-formats a date string form the current format to the specified format.
	 * @param _sDate
	 *           Date string to re-format
	 * @param _sCurrFormat
	 *           Current format string for date
	 * @param _sDesiredFormat
	 *           Desired format for date
	 ...
	 * 
	 * @param _sDate
	 *            The date you wish to format in xx/xx/xxxx or xx/xx/xx format
	 * @return The date in yyyy-mm-dd format
	 */
	...
	public static String formatFullReadableDateForMySQL(String _sDate)
	{
		if (_sDate != null && !_sDate.equals(""))
		{
			...
			sDay = XSaLTStringUtils.padLeftWithCharacter(_sDate.substring(_sDate.indexOf("/") + 1, _sDate.lastIndexOf("/")), '0', 2);
	 ...
	 * 
	 * @param _sDate
	 *            The date you wish to format in OXOXXXXX or XXXXXX format (4-digit year)
	 * @return The date in yyyy-mm-dd format
	 */
	 ...
	 * 
	 * @param _sDate
	 *            The date you wish to format in OXOXXX or XXXXXX format (2-digit year)
	 * @return The date in yyyy-mm-dd format
	 */
	 ...
	 * 
	 * @param _sDate
	 *            The date you wish to format in xx/xx/xxxx format -- uses slashes to fix
	 * @return The date in yyyy-mm-dd format
	 */
	 ...
	 * 
	 * @param _sDate
	 *            The date you wish to format in xx/xx/xxxx xx:xx:xx format
	 * @return The date in yyyy-mm-dd hh:mm:ss format
	 */
	 ...
	 * 
	 * @param _sDate
	 *            The date you wish to format in xxxx-xx-xx xx:xx:xx format
	 ...
	 * 
	 * @param _sDate
	 *            The date you wish to format in xxxx-xx-xx format
	 ...
	 * 
	 * @param _sOrignalString
	 *            String for replacing delimiter
	 * @param _sOldDelimiter
	 *            Delimiter to replace
	 * @param _sNewDelimiter
	 *            Replacement delimiter
	 * @return String with delimiters replaced
	 */
	public static String replaceDelimitersInString(String _sOrignalString, String _sOldDelimiter, String _sNewDelimiter)
	{
	...
	/**
	 * This method capitalizes the first character after a space in
	 ...
	 * 
	 * @param _sInput
	 *            The string comma-delimited values to convert
	 * @param _bConvertToUpperCase
	 *            The flag to change the values to uppercase
	...
	/**
	 * This method returns an ArrayList from a string split by the provided delimiter.
	 * 
	 * @param _sInput
	 *            The string to split
	 * @param _sDelimiter
	 ...
	 *            The delimiter to split on
	 * @param _bConvertToUpperCase
	 *            Flag if all values should be converted to upper case
	 * @return ArrayList of values from the passed string. 
	 */
	public static ArrayList<String> splitStringToArrayList(String _sInput, String _sDelimiter, boolean _bConvertToUpperCase)
	{
		ArrayList<String> oArrayList = new ArrayList<String>();
	...
	{
		DateFormat oDateFormatter = new SimpleDateFormat(XSaLTConstants.XS_DATETIME_FORMATTER_NO_SLASHES_NO_UNDERSCORE_WITH_MILLI);
		return oDateFormatter.format(new Date());
	}

	/**
	 * This method returns the current date & time in this format - MM/dd/yyyy HH:mm:ss
	 * 
	...
	/**
	 * The method will strip out the garbage that would mess up a standard SQL insert
	 * 
	 * @param _sRegExProcessString
	 *            The String to strip out garbage in a given String
	 * @return The cleaned up String
	 */
	 ...
	 * 
	 * @param _sRegExProcessString
	 *            The String to replace quotes with minute marks
	 * @return The cleaned up String
	 */
	 ...
	 * 
	 * @param _sRegExProcessString
	 *            The String to replace hyphens with spaces
	 * @return The cleaned up String
	 */
	 ...
	 * 
	 * @param _sRegExProcessString
	 *            The String to replace directionals
	 * @return The cleaned up String
	 */
	 ...
	 * 
	 * @param _sRegExProcessString
	 *            The String to replace extra spaces
	 * @return The cleaned up String
	 */
	...
	/**
	 * This method replaces multiple, consecutive spaces with a single space
	 * and removes any spaces before or after a line break.
	 * 
	 * @param _sRegExProcessString
	 *            The string to process
	 * @return The cleaned up string
	 ...
	 * 
	 * @param _sRegExProcessString
	 *            The String to replace backslashes with forwardslashes
	 * @return The cleaned up String
	 */
	 ...
	 * 
	 * @param _sRegExProcessString
	 *            The String to replace forwardslashes with periods
	 * @return The cleaned up String
	 */
	 ...
	 * 
	 * @param _sRegExProcessString
	 *            The String to replace spaces with underscores
	 * @return The cleaned up String
	 */
	 ...
	 * 
	 * @param _sRegExProcessString
	 *            The String to strip non-numbers
	 * @return The cleaned up String
	 */
	...
	/**
	 * This method removes all non-numeric characters from a string, leaving
	 * any periods and dashes (for decimals and negative numbers).
	 * 
	 * @param _sRegExProcessString
	 * @return
	 */
	...
	/**
	 * The method will replace standard comma-delimited with tabs from a given String
	 * 
	 * @param _sRegExProcessString
	 *            The String to replace standard comma-delimited with tabs
	 * @return The cleaned up String
	 */
	...
	/**
	 * The method will clean up a given string to be database column name safe (less reserved words)
	 * 
	 * @param _sRegExProcessString
	 *            The String to clean up a given string to be database column name safe (less reserved words)
	 * @return The cleaned up String
	 */
	...
	/**
	 * This method will replace "->" with a tab and the space after "router"
	 * with a tab.
	 * 
	 * @param _sRegExProcessString
	 *            The string to process
	 ...
	 * 
	 * @param _sRegExProcessString
	 *            The String to strip trailing slashes
	 * @return The cleaned up String
	 */
	 ...
	 * @param _nNumberOfPad
	 *            The number of places to pad on the left
	 ...
	 *            The character to pad the String with
	 * @param _nNumberOfPad
	 *            The number of places to pad on the right
	 * @return The String padded with the characters
	 */
	 ...
	 * 
	 * @param _oRegExHashMap
	 *            The regex LinkedHashMap from this class
	 * @param _sRegExProcessString
	 *            The String to process against
	 * @return The final processed String
	 */
	public static String processRegExHashMap(LinkedHashMap<String, String> _oRegExHashMap, String _sRegExProcessString)
	{
		if (_sRegExProcessString != null)
		{
			...
			for (Iterator<String> i = _oRegExHashMap.keySet().iterator(); i.hasNext();)
			{
				...
				oTempStringBuffer = new StringBuffer(oTempStringBuffer.toString().replaceAll(sRegExFind, sRegExReplace));
			}
			return oTempStringBuffer.toString();
		}
		else
	...
	/**
	 * The method will return an default string (specified) if a given String is null
	 * 
	 * @param _sTempString
	 *            The String to check
	 * @param _sDefaultValue
	 *            The default to return if the value is null
	 * @return The return value of the processed String
	 */
	...
	/**
	 * The method will return an default string (specified) if a given value in a LinkedHashMap is null
	 * 
	 * @param _oTestMap
	 *            The LinkedHashMap to test
	 * @param _sKeyString
	 *            The key to test within the LinkedHashMap
	 * @param _sDefaultValue
	 *            The default value to use if not found, or if that value is null
	 * @return The string value of the LinkedHashMap key, or the default value
	 */
	public static String getDefaultStringIfLinkedHashMapValueIsNull(LinkedHashMap<String, String> _oTestMap, String _sKeyString, String _sDefaultValue)
	{
	...
	/**
	 * The method will return an default string (specified) if a given value in a HashMap is null
	 * 
	 * @param _oTestMap
	 *            The HashMap to test
	 * @param _sKeyString
	 *            The key to test within the HashMap
	 * @param _sDefaultValue
	 *            The default value to use if not found, or if that value is null
	 * @return The string value of the HashMap key, or the default value
	 */
	public static String getDefaultStringIfHashMapValueIsNull(LinkedHashMap<String, String> _oTestMap, String _sKeyString, String _sDefaultValue)
	{
		if (_oTestMap.get(_sKeyString) == null)
		{
			return _sDefaultValue;
	...
	/**
	 * The method will return a default long (specified) if the String value is null or empty
	 * 
	 * @param _sTempString
	 *            The String to test
	 * @param _nDefaultLong
	 *            The default long value to return if the String value is null or empty
	 * @return The long value of the String, or the default long value to return if the String value is null or empty
	 */
	...
	/**
	 * This method will return a default int (specified) if the String value is
	 * null or empty.
	 * 
	 * @param _sTempString
	 *            The String to test
	 * @param _nDefaultInt
	 *            The default value to return if the String to test is invalid.
	 * @return The int value of the string, or the default int value if the String is invalid
	 */
	 ...
	 * @param _sTempString
	 *            The String to test
	 * @param _nDefaultDouble
	 *            The default value to return if the String to test is invalid.
	 * @return The double value of the string, or the default double value if the String is invalid
	 */
	 ...
	 * @param _sStringPattern
	 *            The simple String pattern to test for
	...
	public static boolean checkWildCard(String _sStringPattern, String _sStringToCheck)
	{
		...
		// boolean myRetvalue = StringUtils.checkWildCard("ste*tte", "stephan cossette");
		boolean bMatch = true;
	...
	/**
	 * This method tests if the String is null, if it is, a blank String is returned.
	 * If the String is not null, the String returned will have the first letter of
	 * each word capitalized.
	 * 
	 * @param _sIn
	 *            The string to test and format
	 * @return A blank String if the input is null, otherwise a string with the first letter of each word capitalized
	 */
	...
	/**
	 * This method will format an account number with the separators missing into the
	 * specified account format with the specified separator.
	 * 
	 * @param _sFormatString
	 *            The desired format
	 * @param _sAccountNumber
	 *            Account number to format
	 * @param _cSeparator
	 *            Separator in format string
	 * @return Formatted account number
	 */
	public static String formatUnformattedAccountNumber(String _sFormatString, String _sAccountNumber, char _cSeparator)
	{
		StringBuffer oRv;
	 ...
	 * 
	 * @param _sCCExpDate
	 *            The date to format in MMyy or MMyyyy format
	...
	/**
	 * This method will parse a datetime in the standard MySQL format into a java.util.Date object.
	 * 
	 * @param _sDateString
	...
	public static Date getDateObjFromMySQLDatetimeString(String _sDateString)
	{
		...
		{
			XSaLTGenericLogger.error("Unable to parse date string: " + _sDateString, e);
		}
	...
	/**
	 * This method will parse a date in the standard MySQL format into a java.util.Date object.
	 * 
	 * @param _sDateString
	 *            The date string to parse.
	 * @return A java.util.Date object set to the datetime in the original string.	 * 
