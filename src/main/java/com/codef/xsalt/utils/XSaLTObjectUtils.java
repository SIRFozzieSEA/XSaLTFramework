...
public class XSaLTObjectUtils
{
	...
	*/
	...
	/**
	 * This method concatenates each string from an array in to a single
	 * delimited string.
	 * 
	 * @param _asString
	 *            Array of strings to make into CSV
	 * @param _sDelimiter
	...
	public static String getStringArrayWithDelimiter_String(String _asString[], String _sDelimiter)
	{
		...
		oTempBuffer = new StringBuffer(oTempBuffer.toString().substring(0, oTempBuffer.toString().length() - _sDelimiter.length()));
	...
	/**
	 * This method casts the specified object to a HashMap<String, HashMap<String, String>>.
	 * 
	 * @param _oConvertObject
	 *            Object to convert
	 * @return HashMap<String, HashMap<String, String>> converted from incoming object
	 */
	@SuppressWarnings("unchecked")
	public static HashMap<String, HashMap<String, String>> getObjectAsHashMap_String_HashMapStringString(Object _oConvertObject)
	{
	...
	/**
	 * This method iterates through a HashMap, putting each key-value pair
	 * into a string.
	 * 
	 * @param _oTestMap
	 *            Map to list
	 * @param _sIndentChar
	 *            Character to put at the beginning of each line
